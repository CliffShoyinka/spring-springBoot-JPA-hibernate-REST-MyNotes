...
import com.example.config.ProjecConfig;
...
public class example {
    ...
    public static void main(String[] args) {
        ...
        var context = new AnnotationConfigApplicationContext(ProjecConfig.class);
        ...
        try {
            volksVehicle = context.getBean("audi",Vehicle.class);
